...
var modal = document.getElementById("add-item-dialogue");
...
function showTodoList() {
    ...
    todoList.forEach((element, index) => {
        ...
        if(element.done === "Yes") {
            listTag += `<li><input id="task-done${index}" type="checkbox" checked>${element.title}<span class="icon" onclick="deleteTask(${index})"><i class="fas fa-trash"></i></span></li>`;
        } else {
            listTag += `<li><input id="task-done${index}" type="checkbox">${element.title}<span class="icon" onclick="deleteTask(${index})"><i class="fas fa-trash"></i></span></li>`;
        }
    });
